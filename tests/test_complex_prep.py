...
class TestMDOrionFloes(FloeTestCase):
    ...
    def test_compex_prep_floe(self):
        ...
        for record in records:
            ...
            self.assertTrue(record.has_value(Fields.simwellid))
