...
PLmask = OpenMMmakePLmaskCube('PLmask', title='Make P-L Mask')
...
warmup = OpenMMwarmupNVTCube('warmup', title='warmup')
warmup.promote_parameter('picosec', promoted_name='warm_psec', default=10.0)

equil1 = OpenMMequilCube('equil1', title='equil1')
...
equil2 = OpenMMequilCube('equil2', title='equil2')
...
equil3 = OpenMMequilCube('equil3', title='equil3')
...
prod = OpenMMequilCube('prod', title='Production_MD')
...
job.add_cubes(ifs, charge, lig_param, complex_setup, PLmask,
